(function () {
    angular.module('inflightApp.jcarouselec', []).directive('carousel', carousel).controller('economyMenuController', economyMenuController);
    ...
    function carousel() {
        return {
            ...
            template: '<div class="jcarousel-wrapper"><div class="jcarousel"><ul><li ng-repeat="img in images"><img src="{{img.imageKey}}" ui-sref="app.menu" style="cursor:pointer; max-width:300px;"/></li></ul></div><a href="javascript:void(0)" class="jcarousel-control-prev">&lsaquo;</a><a href="javascript:void(0)" class="jcarousel-control-next">&rsaquo;</a></div>',
    ...
    function economyMenuController($scope, micrositeApi, selector) {
